    ...
    return (
      <View style={{
        ...
        <ScrollView contentContainerStyle={styles.contentContainer}>
          <Image square size={80} source={findImg(state.params.profile.username)} 
          style={{ width: 92, height: 92, marginLeft: 142 }} />
          <Text style={{ fontSize: 24, marginTop: 10, marginLeft: 125 }}>
          {state.params.profile.username} {state.params.profile.gender}</Text>
          <ListItem 
          style={{ backgroundColor: '#E9E9E9', marginTop: 45, 
          marginLeft: 0, width: 375, height: 45 }}>
          ...
          marginLeft: 0, width: 375, height: 45 }}>
            ...
            <Text 
            style={{ marginLeft: 15 }}>Phone: {state.params.profile.phone}</Text>
          </ListItem>
          <ListItem 
          ...
          marginLeft: 0, width: 375, height: 45 }}>
            ...
            Birthday: {state.params.profile.DOB}</Text>
          </ListItem>
          <ListItem 
          style={{ backgroundColor: '#FFFFFF', marginLeft: 0, width: 375, height: 45 }}>
            <Icon name="logo-dribbble" 
            style={{ marginLeft: 5 }} />
            <Text style={{ marginLeft: 15 }}>Interests: </Text>
            <Button rounded style={{ backgroundColor: [state.params.profile.color1], 
              width: 93, height: 23, marginLeft: 5 }}>
              <Text style={{ color: '#FFFFFF', fontSize: 12 }}>
              {state.params.profile.interest1}</Text>
            </Button>
          </ListItem>
          ...
          marginLeft: 0, width: 375, height: 45 }}>
            ...
            <Text style={{ marginLeft: 15 }}>
            Credit Score: {state.params.profile.credit}</Text>
          </ListItem>
        </ScrollView>
        <Button block dark style={{ width: 353, height: 41, 
          marginLeft: 11, marginBottom: 20 }}>
